      ...
      <div class="col">
        ...
        <form-tag @userEditEvent="submitHandler" name="userform" event="userEditEvent">
          ...
          <div class="form-ckeck">
            <input v-model="user.active"  id="user-active" :value="1" type="radio" class="form-check-input">
            <label for="user-active" class="form-check-label">Active</label>
          </div>  
          <div class="form-ckeck">
            <input v-model="user.active"  id="user-active-2" :value="0" type="radio" class="form-check-input">
